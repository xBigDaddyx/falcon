...
use Xbigdaddyx\Falcon\Filament\Resources\StatusResource\Pages;
use Xbigdaddyx\Falcon\Filament\Resources\StatusResource\RelationManagers;
...
class StatusResource extends Resource
{
    ...
    {
        return trans('falcon::falcon.resource.status.label');
    }
    ...
    {
        return trans('falcon::falcon.resource.status.single');
    }

    public static function getNavigationGroup(): ?string
    {
        return trans('falcon::falcon.resource.status.group');
    }

    public function getTitle(): string
    {
        return trans('falcon::falcon.resource.status.title.resource');
    }
